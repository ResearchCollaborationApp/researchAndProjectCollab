        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    ...
                    <p className="mt-2 text-base text-gray-600">Already have an account? <Link to="/login" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 hover:underline focus:text-blue-700">Log in</Link></p>
                    <form action="#" method="POST" className="mt-8">
                        <div className="space-y-5">
                            <div>
                                <label for="" className="text-base font-medium text-gray-900"> School </label>
                            ...
                            <div>
                                <label for="" className="text-base font-medium text-gray-900">College email</label>
                                <div className="mt-2.5">
                                    <input
                                        type="email"
                                        name=""
                            ...
                            <div>
                                <div className="flex items-center justify-between">
                                    ...
                                    <a href="#" title="" className="text-sm font-medium text-blue-600 hover:underline hover:text-blue-700 focus:text-blue-700">  </a>
                                </div>
                                <div className="mt-2.5">
                                    <input
                                        type="password"
