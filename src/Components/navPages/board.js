        ...
        >
          ...
          <div className="mt-6 flex gap-8 sm:gap-6">
            ...
            <div className="flex flex-col">
              <Link
                to="#"
                className="bg-blue-400 font-semibold group relative inline-flex items-center overflow-hidden rounded-md border px-8 py-3 focus:outline-none focus:ring"
               
              >
                <span className="absolute mt-4 end-full transition-all group-hover:end-4">
                  <svg
                    className="size-5 rtl:-rotate-1"
